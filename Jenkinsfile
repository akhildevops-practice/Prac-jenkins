    ...
    stages {
        ...
        stage('Git Staging'){
            ...
            steps{
                ...
                checkout([$class: 'GitSCM', branches: [[name: '*/master']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-cred', url: 'https://github.com/akhildevops-practice/Prac-jenkins.git']]])
